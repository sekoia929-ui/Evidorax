  ...
  return (
    <html>
      <body style={{ margin: 0, fontFamily: 'monospace' }}>
        <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24, background: '#F6F6F3' }}>
          <div style={{ maxWidth: 640, background: '#fff', border: '1px solid #E4E2DC', borderRadius: 4, padding: 24 }}>
            <div style={{ fontSize: 13, color: '#B23A2E', fontWeight: 600, marginBottom: 10 }}>EvidoraX crashed at startup — here's why</div>
