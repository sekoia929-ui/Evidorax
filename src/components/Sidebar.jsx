...
export default function Sidebar({ projects = [], activeProjectId, onSelectProject, onNewProject, onDeleteProject, plan = 'free', papersUsed = 0, papersLimit = 5, userEmail, onSignOut, onUpgrade, onRequestDeletion }) {
  return (
    <aside style={{
      width: 260,
      minWidth: 260,
